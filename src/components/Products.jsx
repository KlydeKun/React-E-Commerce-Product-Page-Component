...
import close from "../icons/icon-plus.svg"
...
const Products = () => {
  ...
  return (
    <>
      ...
      />}
      <section className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 lg:mt-10 lg:place-items-center lg:py-20">
        <article>
          <div>
            {products.map((item, index) => (
              <div
        ...
        <article className="px-8 pb-10">
          <h2 className="bg-slate-100 py-1 px-2 text-orange-400 uppercase trackingw-wide text-sm font-bold inline-block rounded shadow mb-10">
            Sneaker Company
          </h2>
          ...
          <div className="flex flex-wrap items-center justify-between lg:flex-col lg:items-start">
